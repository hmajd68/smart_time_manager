...
class DashboardPage:
    ...
    def build(self):
        try:
            ...
            self.content = ft.Column([
                ft.Text("❌ خطا در بارگذاری داشبورد", size=20, color=ft.Colors.RED_700),
                ft.Text(str(e), size=14, color=ft.Colors.RED_400),
            ])
    ...
    def _task_item(self, task):
        ...
        return ft.Container(
            content=ft.Row([
                ...
                ft.Text(task.title, size=14, rtl=True, expand=True),
